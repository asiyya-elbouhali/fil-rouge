...
const props = defineProps(['BusinessCategories']);
const csrfToken = ref('');
const formData = ref({
  name: '',
  number_of_devices: '',
...
const submitForm = async () => {
  try {
    ...
    data.append('number_of_devices', formData.value.number_of_devices);
    data.append('description', formData.value.description);

    const response = await axios.post('/addBusinessCategory',data, {
      headers: {
...
const deleteBusinessCategory = async (id) => {
  try {
    const response = await axios.delete(`/BusinessCategory/${id}`);
...
// UPDATE FUNCTION
function editBusinessCategory(data) {
...
const saveChanges = async () => {
  try {
    ...
    const response = await axios.put(`/BusinessCategory/${id}`,formDataEdit.value); 
    console.log(response.data)
  } catch (error) {
    // Handle error response
    ...
    <button @click="showModal = true">Edit</button>
     <div v-if="showModal" class="modal-test  fixed mx-20 my-3 overflow-y-auto py-18 inset-2 z-50 flex items-center justify-center">
      <div class="modal-content bg-white  p-8 rounded-lg shadow-lg">
        <h2 class="pt-20">Edit Business Category</h2>
        <form>
          ...
          <div class="mt-2">
            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
             ...
             <div class="sm:col-span-3">
            <label for="version" class="block text-sm font-medium leading-6 text-gray-900">Number of devices</label>
          <div class="mt-2">
            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">

              <input type="number"
               v-model="formDataEdit.number_of_devices"
                ...
                <div class="bg-white shadow-md rounded my-6">
                    ...
                    <table class="min-w-max w-full table-auto">
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            <tr
                            v-for="BCategory in BusinessCategories" :key="BCategory.id"
                            ...
                            class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        ...
                                        <button
                                        @click="editBusinessCategory(BCategory)"
                                        ...
                                        <button
                                        @click="deleteBusinessCategory(BCategory.id)"
    ...
    <div class="relative w-screen px-20 max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white justify-center flex">Add New Category</h3>
    ...
    <div class="border-b border-gray-900/10 pb-12">
      ...
      <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <div class="sm:col-span-3">
          ...
          <div class="mt-2">
            <input 
            v-model="formData.number_of_devices"
