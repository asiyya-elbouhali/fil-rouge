...
const submitForm = async () => {
  try {
    ...
    const response = await axios.post('/addGateway',data, {
      headers: {
...
const deleteGateway = async (id) => {
  try {
    const response = await axios.delete(`/gateway/${id}`);
...
const saveChanges = async () => {
  try {
   ...
   const response = await axios.put(`/gateway/${id}`,formDataEdit.value);
    console.log(response.data)
  } catch (error) {
    // Handle error response
    ...
    <button @click="showModal = true">Edit</button>
     <div v-if="showModal" class="modal-test  fixed mx-20 my-3 overflow-y-auto py-18 inset-2 z-50 flex items-center justify-center">
      <div class="modal-content bg-white  p-8 rounded-lg shadow-lg">
        <h2 class="pt-20">Edit Gateway</h2>
        <form>
        ...
        <div
            ...
            <div class="w-full lg:w-6/6 mx-5">
                <div class="bg-white shadow-md rounded my-6">
                    ...
                    <button
                    data-modal-target="GatewayModal"
                    data-modal-toggle="GatewayModal"
                    type="button"
                    ...
                    <table class="min-w-max w-full table-auto">
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            <tr
                            v-for="Gateway in Gateways" :key="Gateways.id"
                            ...
                            class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        ...
                                        data-modal-target="editGatewayModal"
                                        data-modal-toggle="editGatewayModal"
                                        class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <!-- edit software  -->
                                <div id="editGatewayModal" tabindex="-1" aria-hidden="true"
...
<div id="GatewayModal" tabindex="-1" aria-hidden="true"
class="fixed top-0 left-0 right-0  z-50 hidden w-screen p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-screen px-20 max-h-full">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
